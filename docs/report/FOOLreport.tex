...
% TODO inserisci esempio di programma

Le espressioni sono state estese a comprendere gli operatori $<=, >=, ||, \&\&, /, - $
   e not nella seguente maniera:\\

% TODO inserire grammatica fool come codice o come immagine relativamente a exp, operand, term, factor, atom

Sono stati aggiunti gli statement\\

% TODO inserire stm e stms, come prima
...
% TODO inserisci esempio di classe scritta in .fool
...
% TODO inserisci regola classdec
