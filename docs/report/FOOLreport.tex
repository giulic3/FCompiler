...
%TODO controllare che siano giuste
% TODO mancano i tipi base
\begin{itemize}
...
$$ \frac{}{\vdash true : Bool}[BoolVal_1] \qquad \frac{}{\vdash false : Bool}[BoolVal_2] $$
  ...
  \item le variabili %TODO check
  $$ \frac{}{\Gamma [x \rightarrow T] \vdash x : T}[Var] $$
  \item la chiamata di funzione

  $$ \frac{\Gamma \vdash f : (T_1, ..., T_n) \rightarrow T \qquad a_1 : S_1 <: T_1 \ \ldots \ a_n : S_n <: T_n}{\Gamma \vdash f(S_1 \ a_1,...,S_n \ a_n) : T}[FunExp] $$

  \item la chiamata di metodo

  \item l'istanziazione di un oggetto (new)
